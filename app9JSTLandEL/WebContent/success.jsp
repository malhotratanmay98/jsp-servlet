<!-- Expression Language is good but we can't do looping with it 
So we use JSTL for this purpose. Make sure to copy the JSTL jar file in lib and do build path -->
